// src/App.jsx — Tijuana Accesible · v2
// Apple/iOS 26 Liquid Glass · integra: Places Autocomplete, Elevation API,
// banquetas OSM coloreadas, TutorialRapido como sheet, folios TJA- en cuadrillas.
...
import {
  ...
  ChevronRight, HelpCircle, Crosshair, Layers, X,
} from "lucide-react";
...
// ── ROUTE VIEW · con Places Autocomplete + Elevation + Quick destinos ─────
function RouteView({ profile, reports }) {
  ...
  // Dibujar polylines cuando cambian paths o tab
  useEffect(() => {
  ...
  const calc = async () => {
    ...
    try {
      ...
      // Elevation API en la ruta más corta
      let slope0 = 0;
      try {
...
function Frame({ children }) {
  return (
    <div style={{ maxWidth: 430, margin: "0 auto", minHeight: "100vh", background: SURFACE_2, display: "flex", flexDirection: "column", boxShadow: "0 0 60px rgba(0,0,0,0.04)", fontFamily: FONT }}>
      {children}
    </div>
  );
}
